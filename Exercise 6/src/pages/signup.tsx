            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div>
                ...
                <input type="password" id="password" {...register('password', { required: true, minLength: 8 })} 
                  ...
                  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${errors.password && 'border-red-500'}`} 
                  required />
              ...
              <div>
                ...
                <input type="password" id="confirmPassword" {...register('confirmPassword', { required: true, minLength: 8 })} 
                  placeholder="••••••••" className={`bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg 
                  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 
                  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${errors.confirmPassword && 'border-red-500'}`} 
                  required />
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">I accept the{' '} 
                    <a className="font-medium text-black hover:underline dark:text-white" href="#">Terms and Conditions</a></label>
                </div>
              </div>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <Link href="/" className="font-medium text-black hover:underline dark:text-white">Login here</Link>
              </p>
            </form>
          </div>
        </div>
