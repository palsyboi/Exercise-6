        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            <input type="email" id="email" {...register('email', { required: true, pattern: /^\S+@\S+$/i })}
              className={`w-full bg-gray-100 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 text-center">
            ...
            <Link href="/signup"
              className="font-medium text-black hover:underline dark:text-white">Signup
            </Link>
          </p>
        </form>
      </div>
